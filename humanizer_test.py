...
# Remarks for each prediction value
remarks_dict = {
    1: [
...
# Function to select a random remark based on the prediction value
def select_random_remark(prediction):
    return random.choice(remarks_dict[prediction])

# Example usage:
prediction = 1  # Example prediction value
selected_remark = select_random_remark(prediction)
print(selected_remark)
